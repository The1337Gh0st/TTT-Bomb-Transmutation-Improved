...
if SERVER then
   AddCSLuaFile()
	resource.AddWorkshop( "2775347604" )
...
local swep_kq_explosion_radius = CreateConVar("swep_kq_explosion_radius", 10, {FCVAR_NOTIFY, FCVAR_ARCHIVE},
												"Explosion radius")
local swep_kq_delay = CreateConVar("swep_kq_delay", 1, {FCVAR_NOTIFY, FCVAR_ARCHIVE},
...
local swep_kq_remove = CreateConVar("swep_kq_remove", 1, {FCVAR_NOTIFY, FCVAR_ARCHIVE},
												"Whether or not the bomb will remove something upon use")
CreateConVar("swep_kq_charges", 3, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "How many charges Bomb Transmutation starts with", 0, 100)												
CreateConVar("swep_kq_primary_delay", 1, {FCVAR_NOTIFY, FCVAR_ARCHIVE}, "Attack delay after setting a bomb and triggering a bomb", 0, 100)
